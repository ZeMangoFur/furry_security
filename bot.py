...
async def _lover8(ctx, *, question):
    ...
    await ctx.send(f'The love between {author_name} and {question} is {random.randint(1,100)}%')
...
async def _gayr8(ctx):
    ...
    embed = discord.Embed(title=f'{author_name} is {random.randint(1,100)}% gay',
                          color=discord.Color.blue())
    await ctx.send(embed=embed)
...
async def _simpr8(ctx):
    ...
    embed = discord.Embed(title=f'{author_name} is {random.randint(1,100)}% a simp',
                          color=discord.Color.blue())
    await ctx.send(embed=embed)
